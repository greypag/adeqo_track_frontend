...
#         
  ...
  def event
        ...
        params_array = []
        params_except_array = ["action","category","companyid","controller","event_type","name","order_id","price","promotecode","revenue","sku"]
...
#     
  ...
  def db
    ...
    if @db2.nil?
        @db2 = Mongo::Client.new([ '10.215.106.65:27017' ], :database => 'adeqo', :connect => :direct , :timeout => 15, :max_pool_size => 50, :pool_timeout => 15, :socket_timeout => 15, :connect_timeout => 15)
        @db2.close  
    end
    ...
    # @db2 = Mongo::Client.new([ '10.215.104.60:27017' ], :database => 'adeqo', :connect => :direct , :timeout => 1, :max_pool_size => 1, :pool_timeout => 1, :socket_timeout => 1, :connect_timeout => 1)
